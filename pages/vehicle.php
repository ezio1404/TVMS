<?php
    ...
    if(isset($_SESSION['id']) && isset($_SESSION['head'])){
        if(isset($_POST['add'])){
            ...
            $vehicle->addVehicle(array($plate,$brand,$color,$register,$expire,$status,$type),$plate);
        }
        ...
        if(isset($_POST['edit'])){
            ...
            $status = $_POST['status'];
            $type = $_POST['type'];
            $vehicle->updateVehicle(array($plate,$brand,$color,$register,$expire,$status,$type,$id));
        }
    }
    else{
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="panel-body">
                        <p>
                            <button type="button" class="btn btn-outline btn-info"  data-toggle="modal" data-target="#vehicleModal">Add Vehicle</button>
                        </p>
                <!-- start modal -->
                <!-- Modal -->
                            ...
                            <table class="table table-hover table-striped table-bordered" id="example" width="100%">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td> 
                                            <a style="text-decoration:none" href="#edit<?php echo $datas['vehicle_plateNo'] ?>" data-toggle="modal"><i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i></button>
                                            <a onclick='javascript:confirmation($(this));return false;' href="deleteVehicle.php?id=<?php echo $datas['vehicle_plateNo'] ?>" style="text-decoration:none" > <i class="fa fa-trash-o fa-lg" aria-hidden="true"></i> </a> 
                                        </td>
                                    </tr>
                                <?php
                                    }
            ...
            <div class="modal fade" id="edit<?php echo $datas['vehicle_plateNo'] ?>" tabindex="-1" role="dialog" aria-labelledby="enforcerModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <h5 class="modal-title" id="enforcerModalLabel">Edit Vehicle</h5>
                        </div>
                        <div class="modal-body">
                        <form method = 'POST'>
                            <input type="hidden" name="id" class="form-control" value="<?php echo $datas['vehicle_plateNo'] ?>" autofocus><br>
                            <p>Plate Number</p>
                            <input type="text" name="plate" class="form-control" value="<?php echo $datas['vehicle_plateNo'] ?>" required autofocus><br>
                            <p>Brand</p>
                            <input type="text" name="brand" class="form-control" value="<?php echo $datas['vehicle_brand'] ?>" required autofocus><br>
                            <p>Color</p>
                            <input type="text" name="color" class="form-control" value="<?php echo $datas['vehicle_color'] ?>" required autofocus><br>
                            <p>Last Registered Date</p>
                            <input type="date" name="register" class="form-control" value="<?php echo $datas['vehicle_lastRegisteredDate'] ?>" required autofocus><br>
                            <p>Expiry Date</p>
                            <input type="date" name="expire" class="form-control" value="<?php echo $datas['vehicle_expiryDate'] ?>" required autofocus><br>
                            <p>Status</p>
                            <input type="text" name="status" class="form-control" value="<?php echo $datas['vehicle_status'] ?>" required autofocus><br>
                            <p>Type</p>
                            <input type="text" name="type" class="form-control" value="<?php echo $datas['vehicle_type'] ?>" required autofocus><br>
                        </div>
                        <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
