...
<body>             
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-hover table-striped table-bordered" id="example" width="100%">
                            ...
                            <tbody>
                            <?php
                                $data = $agency->getAgency();
                                foreach($data as $datas){
                            ?>
                                <tr>
                                    <td><?php echo $datas['agency_id'] ?></td>
                                    ...
                                    <td><?php echo $datas['agency_status'] ?></td>
                                    <td> 
                                        <a href="#view<?php echo $datas['agency_id'] ?>" data-toggle="modal" style="text-decoration:none"><i class="fa fa-eye fa-lg" aria-hidden="true"></i></button>
                                        <?php if($datas['agency_status'] == 'Active'){ ?>
                                        <a onclick='javascript:status($(this));return false;' href="agencyStatus.php?status=<?php echo $datas['agency_status']?>&id=<?php echo $datas['agency_id'] ?>"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></a> 
                                        <?php }
                                              else{
                                        ?>
                                        <a onclick='javascript:status($(this));return false;' href="agencyStatus.php?status=<?php echo $datas['agency_status']?>&id=<?php echo $datas['agency_id'] ?>"><i class="fa fa-unlock fa-lg" aria-hidden="true"></i></a> 
                                        <?php } ?>
                                    </td>
                                </tr>
                                <?php } ?>
            ...
            <div class="modal fade" id="edit<?php echo $datas['agency_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="enforcerModalLabel" aria-hidden="true">
                ...
                <div class="modal fade" id="view<?php echo $datas['agency_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="enforcerModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                    <div class="modal-content" style="width:70%">
                        ...
                        <h5 class="modal-title" id="enforcerModalLabel">View Agency</h5>
                        </div>
                        <div class="modal-body">
                        <form method = 'POST'>
                            <p>ID: <?php echo $datas['agency_id'] ?></p><br>
                            <p>Name: <?php echo $datas['agency_name']?></p><br>
                            <p>Provincial Address: <?php echo $datas['agency_head'] ?></p><br>
                            <p>City Address: <?php echo $datas['agency_email'] ?></p><br>
                            <p>Mobile No. : <?php echo $datas['agency_address1'] ?></p><br>
                            <p>Tel No. : <?php echo $datas['agency_address2'] ?></p><br>
                            <p>Gender: <?php echo $datas['agency_tel1'] ?></p><br>
                            <p>Email: <?php echo $datas['agency_tel2'] ?></p><br>
                            <p>Status: <?php echo $datas['agency_status'] ?></p><br>
                        </div>
                        <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        </div>
