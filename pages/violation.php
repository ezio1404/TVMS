            ...
            <div class="container-fluid">
                ...
                <div class="modal fade" id="vpModal" tabindex="-1" role="dialog" aria-labelledby="vpModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST">
                                <input type="text" name="vcode" class="form-control" placeholder="Ordinance No." required autofocus><br>
                                <input type="text" name="vname" class="form-control" placeholder="Article No." required autofocus><br>
                                <input type="text" name="vdesc" class="form-control" placeholder="Violation Description" required autofocus><br>
                                <input type="number" name="vpenalty" class="form-control" placeholder="Violation Penalty" required autofocus><br>
                            </div>
                            ...
                            <table class="table table-hover table-striped table-bordered" id="example" width="100%">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td> 
                                            <a href="#edit<?php echo $datas['violation_id'] ?>" data-toggle="modal" style="text-decoration:none"> <i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i> </a> 
                                            <a onclick='javascript:confirmation($(this));return false;' href="deleteViolation.php?id=<?php echo $datas['violation_id'] ?>" style="text-decoration:none"> <i class="fa fa-trash-o fa-lg" aria-hidden="true"></i> </a> 
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                ...
                <div class="modal fade" id="edit<?php echo $datas['violation_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="vpModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST">
                                ...
                                <p>Ordinance No.</p>
                                <input type="text" name="vcodee" class="form-control" value="<?php echo $datas['ordinanceNo'] ?>" required autofocus><br>
                                <p>Article No.</p>
                                <input type="text" name="vnamee" class="form-control" value="<?php echo $datas['articleNo'] ?>" required autofocus><br>
                                <p>Description</p>
                                <input type="text" name="vdesce" class="form-control" value="<?php echo $datas['violation_desc'] ?>" required autofocus><br>
                                <p>Penalty</p>
                                <input type="number" name="vpenaltye" class="form-control" value="<?php echo $datas['violation_penalty'] ?>" required autofocus><br>
                            </div>
                            <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
